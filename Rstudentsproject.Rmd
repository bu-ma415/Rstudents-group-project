...
ggplot() +
  ...
  geom_sf(data = bos, fill = NA, color = "white", size = 0.05)
...
[Urban:]{.underline} Has more than or equal to **40** other restaurants
within a **100 meter** radius.

[Suburban:]{.underline} Has less than **40** other restaurants within a
**100 meter** radius.
